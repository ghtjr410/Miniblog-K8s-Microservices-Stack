...
const HistoryHeader: React.FC<Props> = ({keycloak, keycloakStatus}) => {
    ...
    const { toHome, toUserBlog, toSearch, toHistory, toHistoryLiked, toHistoryComments, toPostWrite, toSetting} = useNavigationHelper();
